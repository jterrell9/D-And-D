...
public class Beholder extends Monster {
    ...
    public void attack(Entity entity) {
        ...
        switch(attackPatern){
            case 1: case 3:case 5:case 7: case 9:
                print("5 of the eye stalks look towards you and shoot out a red beam. ");
                super.attack(entity, 2 + attackPatern);
                break;
            case 2:case 4:case 6:case 8:case 10:
            	print("5 of the eye stalks look towards you and shoot out a yellow beam. ");
                super.attack(entity, 2 + 4 + attackPatern/2);
                break;
        }
        print("Critical hit by " + getTitle() + ". ");
        if(attackPatern == 10) {
        	print("As you are hit, dazed by the hit, the big eye in the center of the being looks at you and you are hit "
            		+ "with a giant black beam from the main eye. ");
            super.attack(entity, 10);
        }
    }
    ...
    public void die() {
        ...
        if (diePercentage == 20 && !revieved) {
            print("You stab the main eye, hoping for it to be the end of the beholder. It looks injured, and falters. But "
            		+ getTitle()
            ...
            print("You strike 5 eye stalks down, then aim for the last five. As the last eye stalks fall, " + getTitle()
